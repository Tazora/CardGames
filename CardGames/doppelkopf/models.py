...
class Tournament(models.Model):
    ...
    def get_round_points(self, rounds):
        ...
        for r in rounds:
            ...
            points.setdefault(r.player_D, []).append(r.points_D)
...
class Round(models.Model):
    ...
    tournament_played = models.ForeignKey(Tournament, on_delete=models.CASCADE, default=0)
    ...
    def add_points(self, points):
        ...
        self.points_D += int(points.round_points_D)
        return self.save()

    def add_points_single(self, points_A, points_B, points_C, points_D):
        self.points_A += int(points_A)
        self.points_B += int(points_B)
        self.points_C += int(points_C)
        self.points_D += int(points_D)
        return self.save()
    ...
    def recalculate_points(self):
        ...
        for p in points:
            ...
            self.points_D += p.round_points_D
        return self.save()
